...
\usepackage[orientation=landscape,size=custom,width=121.92,height=91.44,scale=1.4,debug]{beamerposter}
...
\begin{beamercolorbox}[wd=\paperwidth,ht=0.17\paperheight,dp=0ex,center,fg=milaWhite]{headline}
        \begin{minipage}[c][0.17\paperheight]{0.64\textwidth}
            \vspace*{-12cm} % same offset so both columns align
        ...
        \end{minipage}%
        \hfill
        \begin{minipage}[c][0.17\paperheight]{0.3\textwidth}
            % {\large Scan for the paper}\\[0.5em]
            \begin{center}
                \vspace*{-8cm} % same offset so both columns align
    ...
    \begin{columns}[t,totalwidth=\textwidth]
        ...
        \begin{column}{0.30\paperwidth}
            ...
            \begin{tcolorbox}[posterbox]
                ...
                This is to outline your method in a concise way. Use visuals to break up the text and make it more engaging.
